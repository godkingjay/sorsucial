...
const GroupCard: React.FC<GroupCardProps> = ({ groupData, sortBy }) => {
	...
	return (
		<div
			className="
        shadow-page-box-1 bg-white rounded-lg entrance-animation-slide-from-right relative
        md:data-[top='true']:col-span-2
      "
			data-top={groupData.index[sortBy] < 3}
			data-order={groupData.index[sortBy] + 1}
		>
			<div className="p-4 flex flex-row flex-wrap justify-center gap-x-4">
				...
				<div className="flex flex-col flex-1">
					...
					<div className="flex flex-row gap-x-2">
						<p className="text-2xs text-gray-500 inline-flex items-center gap-x-1">
							Created by{" "}
							<span className="inline-flex flex-row h-4 w-4">
